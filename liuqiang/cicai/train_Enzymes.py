...
def main(arguments):
    ...
    net = SGANNet(num_layers=arguments.num_layers,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--hidden_dim', type=int, default=64, help='number of hidden units (default: 32)')
